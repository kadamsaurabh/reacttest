			...
			<div class="col-md-8 header">
				...
				<div class="agileits_search">
					<form action="{{ route('product.search' )}}" method="post">
						@csrf
						<input class="search-field" id="search" name="search" type="search" placeholder="How can we help you today?" required="">
				...
				<div class="top_nav_right">
					<div class="wthreecartaits wthreecartaits2 cart cart box_1">
						<a href="{{url('wishlist')}}">wishlist({{ $count = App\Wishlist::count()}})</a> &nbsp;

						<!-- <button class = "w3view-cart"><i class="fa fa-heart" aria-hidden="true"></i></button></a> -->
					
						<a href="{{url('cart')}}">cart({{ $count = App\Cart::count()}})</a>
			...
			<div class="agileits-navi_search">
				<form action="#" method="post">
					...
					<select id="agileinfo-nav_search" name="agileinfo_search" required="">
						...
						<option value="Kitchen">{{$cat->name}}</option>
						@endforeach
					</select>
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								<li class="active">
									<a class="nav-stylehead" href="http://127.0.0.1:8000/home">Home
										...
										<div class="agile_inner_drop_nav_info">
											<div class="col-sm-6 multi-gd-img">
												...
												<ul class="multi-column-dropdown">
													@foreach(App\Category::all() as $cat)
													<li>
														<a href="product2.html">{{$cat->name}}</a>
													</li>
													@endforeach
												</ul>
											</div>
								...
								<li class="dropdown">
									<a class="nav-stylehead dropdown-toggle" href="#" data-toggle="dropdown">Subcategory
										<b class="caret"></b>
									</a>
									<ul class="dropdown-menu agile_short_dropdown">
										@foreach(App\Subcategory::all() as $subcat)
										<li>
											<a href="icons.html">{{$subcat->name}}</a>
										</li>
										@endforeach
									</ul>
								</li>
								<li class="">
									<a class="nav-stylehead" href="http://127.0.0.1:8000/contact">Contact</a>
								</li>
							</ul>
						</div>
					</div>
