							...
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<a href="detail/{{$data['id']}}">
										<img src="image/img/{{$data->image}}" alt="" height="90px" width="120px">
									</a>
								...
								<div class="item-info-product ">
									...
									<div class="info-product-price">
										...
										<!-- <span><a href="cart/{{$data['id']}}"><button type="button" class="btn btn-success">Add To Cart</button></a></span> <br><br> -->
										<span><a href="{{ route('product.addToCart',$data->id) }}"><button type="button" class="btn btn-success">Add To Cart</button></a></span>&#160;&#160; 

										<span><a href="{{ route('product.addToWishlist',$data->id) }}"><button type="button" class="btn btn-primary">Add To Wishlist</button></a></span>
										
										
										<!-- <span><a href="wishlist/{{$data['id']}}"><button type="button" class="btn btn-primary">Add To Wishlist</button></a></span> -->
